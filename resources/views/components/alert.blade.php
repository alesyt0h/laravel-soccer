@if( Session::has('result') )
    @if (Session::get('success'))
        <div class="flex items-center mb-2 bg-emerald-400 text-white text-sm font-bold px-4 py-3" role="alert">
    ...
    @elseif (str_contains(Session::get('result'), 'email verification'))
    ...
    @else
        <div class="bg-red-300 mb-2 border border-red-300 text-red-dark px-4 py-3 rounded relative" role="alert">
            ...
            <span class="block sm:inline">{{ Session::get('result') }}</span>
        </div>
    @endif
@endif
